<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tea and Coffee.aspx.cs" Inherits="final.Tea_and_Coffee" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Tea & Coffee Page</title>
    <style type="text/css">
    ul {
    ...
    <div class="dropdown-content">
      ...
      <a href="Cooking.aspx">Cooking Essentials</a>
        ...
        <br /><br />
             ...
             &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        <asp:Label ID="Label2" runat="server" Text="TEA AND COFFEE" Font-Bold="True" Font-Size="XX-Large" ForeColor="#FF3300"></asp:Label>
        
        <br />
        <br />
        
        <asp:Image ID="Image4" runat="server" Height="751px" ImageUrl="~/images/tea-coffee.jpg" Width="1557px" />
        <br />
             <br />
        </div>
        <br />
        <asp:DataList ID="DataList1" runat="server" CssClass="auto-style3" DataSourceID="SqlDataSource1" RepeatColumns="4" RepeatDirection="Horizontal" OnItemCommand="DataList1_ItemCommand">
            <ItemTemplate>
          ...
          <tr>
              <td class="auto-style7">
                ...
                <br />
                  <br />
                <asp:Image ID="Image6" runat="server" Height="174px" Width="197px" ImageUrl='<%# Eval("Image") %>' />
                <br />
                <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="auto-style4" Height="21px" Width="87px">
                ...
                <br />
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button3" runat="server" BackColor="Red" CssClass="auto-style5" Font-Bold="True" ForeColor="White" Height="43px" Text="Add to Cart" Width="270px" CommandArgument='<%# Eval("ProID") %>' CommandName="addtocart" />
                <br />
                                   </td>
          </tr>
      </table>
        ...
        <br />
        <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sampathfoodcityConnectionString7 %>" SelectCommand="SELECT [ProName], [Price], [Image], [ProID] FROM [product] WHERE ([Category] = @Category)">
            <SelectParameters>
                <asp:Parameter DefaultValue="Tea &amp; Coffee" Name="Category" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>

        <br />
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:sampathfoodcityConnectionString27 %>" SelectCommand="SELECT [ProID], [ProName], [Price], [Image] FROM [product] WHERE (([ProName] LIKE '%' + @ProName + '%') AND ([ProName] LIKE '%' + @ProName2 + '%'))">
            <SelectParameters>
                <asp:ControlParameter ControlID="TextBox1" Name="ProName" PropertyName="Text" Type="String" />
                <asp:ControlParameter ControlID="TextBox1" Name="ProName2" PropertyName="Text" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
