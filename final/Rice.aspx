<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rice.aspx.cs" Inherits="final.Rice" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Image ID="Image1" runat="server" Height="88px" ImageUrl="~/images/promo.lk-promo-68cc07f80b6d4a588aba675992ee3e06-removebg-preview.png" Width="105px" />
    ...
    <div class="dropdown-content">
      ...
      <a href="Cooking.aspx">Cooking Essentials</a>
        ...
        <br /><br />
             ...
             &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        <asp:Label ID="Label2" runat="server" Text="RICE" Font-Bold="True" Font-Size="XX-Large" ForeColor="#FF3300"></asp:Label>
        
        <asp:Image ID="Image4" runat="server" Height="751px" ImageUrl="~/images/collage-different-types-rice-closeup-banner-design-collage-different-types-rice-closeup-banner-design-178453269.jpg" Width="1557px" />
        <br />
             <br />
             <br />
        </div>
        <br />
        <br />
        <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" RepeatColumns="4" RepeatDirection="Horizontal" CssClass="auto-style7" OnItemCommand="DataList1_ItemCommand">
            <ItemTemplate>
          ...
          <tr>
              <td class="auto-style5">
                ...
                <br />
                <br />
                <asp:Image ID="Image5" runat="server" CssClass="auto-style3" Height="148px" ImageUrl='<%# Eval("Image") %>' Width="153px" />
                <br />
                <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                ...
                <br />
                <br />
                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="auto-style4" Height="19px" Width="93px">
                ...
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button3" runat="server" BackColor="Red" Font-Bold="True" ForeColor="White" Height="45px" Text="Add to Cart" Width="182px" CommandArgument='<%# Eval("ProID") %>' CommandName="addtocart" />
                             </td>
          </tr>
      </table>
            </ItemTemplate>
        ...
        <br />
        <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sampathfoodcityConnectionString3 %>" SelectCommand="SELECT [ProName], [Price], [Image], [ProID] FROM [product] WHERE ([Category] = @Category)">
            <SelectParameters>
                <asp:Parameter DefaultValue="Rice" Name="Category" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:sampathfoodcityConnectionString25 %>" SelectCommand="SELECT [ProID], [ProName], [Price], [Image] FROM [product] WHERE ([ProName] LIKE '%' + @ProName + '%')">
            <SelectParameters>
